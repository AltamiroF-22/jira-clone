  ...
  return (
    <DropdownMenu modal={false}>
      ...
      >
        ...
        <DropdownMenuItem
          onClick={() => logOut()}
          className=" flex items-center h-10 justify-center hover:outline-none hover:bg-zinc-100 hover:text-zinc-800 transition text-amber-700 font-medium cursor-pointer"
        >
